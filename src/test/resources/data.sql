insert into person('id', 'name', 'age', 'blood_type','year_of_birthday', 'month_of_birthday','day_of_birthday') values (1, 'martin', 10, 'A',1991, 8, 25);
...
insert into person('id', 'name', 'age', 'blood_type','year_of_birthday', 'month_of_birthday','day_of_birthday') values (3, 'dennis', 8, 'O', 1993, 8, 15);
